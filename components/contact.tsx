...
export const Contact = () => {
  return (
    <section id="contact" className="px-6 py-20 md:py-32 bg-black">
        ...
        <div className="space-y-12">
          ...
          >
            <div className="flex items-center justify-center gap-3">
              ...
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-white">Entre em Contato</h2>
            </div>
            <p className="text-xl text-white/60">Vamos Conversar</p>
              ...
              >
                {info.href ? (
                  <a
                    ...
                    className="flex flex-col items-center gap-3 p-6 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 hover:border-purple-400/50 transition-all duration-300 hover:bg-white/10 group animate-fade-in-up"
                  ...
                  <div className="flex flex-col items-center gap-3 p-6 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 animate-fade-in-up" style={{ animationDelay: `${index * 100}ms` }}>
